...
def main():
    ...
    for sim in range(num_sim):
        ...
        df_loc = pd.read_csv("~/Desktop/indicator_deep_kriging/Bivariate_DeepKriging-main/synthetic_data_simulations_nonGaussian/2d_nongaussian_1200_"+str(sim+1)+".csv", 
                             sep = ",")
        ...
        df_train.to_csv("~/Desktop/indicator_deep_kriging/Bivariate_DeepKriging-main/synthetic_data_simulations_nonGaussian/training_data/2D_nonGaussian_1200_"+str(sim+1)+"-train.csv",
                                                              index = False)
        df_test.to_csv("~/Desktop/indicator_deep_kriging/Bivariate_DeepKriging-main/synthetic_data_simulations_nonGaussian/testing_data/2D_nonGaussian_1200_"+str(sim+1)+"-test.csv",
                        index = False)
...
#         print(y_test)
    ...
    ## MSE saved in file 
    df_mse.to_csv("~/Desktop/indicator_deep_kriging/Bivariate_DeepKriging-main/plot_results/DeepKriging_nongaussian_mse.csv", index = False)
    print(mse_var1)
    print(mse_var2)
