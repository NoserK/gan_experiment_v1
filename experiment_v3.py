...
# ──────────────────────────────────────────────────────────────
# cGAN Architecture  (WGAN-GP + larger G)
# ──────────────────────────────────────────────────────────────
...
class Critic(nn.Module):
    ...
    - No spectral_norm: the gradient penalty is the sole mechanism
      enforcing the 1-Lipschitz constraint on the critic.  In WGAN-GP,
      GP subsumes the role of spectral normalisation (Mod 2) — the
      two are alternative, not complementary, approaches.
    """
...
def main():
    ...
    # ── Summary tables (metrics as rows, methods as columns) ──
    methods = ["cGAN", "KNN", "RF"]
