...
def main():
    ...
    for sim in range(num_sim):
        ...
        #                     sep = ",")
        df_loc = pd.read_csv("~/Desktop/indicator_deep_kriging/Bivariate_DeepKriging-main/synthetic_data_simulations_non-Stationary/2d_nonstationary_1200_"+str(1)+".csv",sep = ",")
        #phi = pd.read_csv("src/python_scripts/phi.csv", 
         #                    sep = ",")
        phi = pd.read_csv("~/Desktop/indicator_deep_kriging/Bivariate_DeepKriging-main/src/python_scripts/phi.csv", 
                             sep = ",")
    ...
    ## MSE saved in file 
    df_mse.to_csv("~/Desktop/indicator_deep_kriging/Bivariate_DeepKriging-main/plot_results/DeepKriging_nonstationary_mse.csv", index = False)
    print(mse_var1)
    print(mse_var2)
