...
# Load nonGaussian datasets and do classification on them 
        df_loc = pd.read_csv("~/Desktop/indicator_deep_kriging/Bivariate_DeepKriging-main/synthetic_data_simulations_nonGaussian_cov/2d_nongaussian_1200_"+str(sim+1)+".csv", 
                             sep = ",")
        ...
        df_train = pd.read_csv("~/Desktop/indicator_deep_kriging/Bivariate_DeepKriging-main/synthetic_data_simulations_nonGaussian_cov/training_data/2D_nonGaussian_1200_"+str(sim+1)+"-train.csv",
                                                              sep = ",")
        df_test = pd.read_csv("~/Desktop/indicator_deep_kriging/Bivariate_DeepKriging-main/synthetic_data_simulations_nonGaussian_cov/testing_data/2D_nonGaussian_1200_"+str(sim+1)+"-test.csv",
                        sep = ",")
    ...
    ## MSE saved in file 
    df_mse.to_csv("~/Desktop/indicator_deep_kriging/Bivariate_DeepKriging-main/plot_results/DeepKriging_nongaussian-cov_mse.csv", index = False)
    print(mse_var1)
    print(mse_var2)
